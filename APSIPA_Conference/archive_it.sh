...
if type optimize-pdf > /dev/null; then
    echo -e "\n[6] optimize-pdf"
    optimize-pdf manuscript.pdf
    if [ -e manuscript-opt.pdf ]; then
	mv manuscript-opt.pdf manuscript-sample.pdf
    else
...
[ -d /Volumes/home/Template ] && cp -v ../APSIPA_Conference.zip /Volumes/home/Template/APSIPA_Conference.zip
